...
<article class="container mx-auto max-w-3xl px-4 py-12">
	...
	<div
		...
		class="prose prose-neutral dark:prose-invert max-w-none break-words [overflow-wrap:anywhere] mo-fade-in
			...
			prose-pre:bg-muted/50 prose-pre:border-2 prose-pre:border-border prose-pre:rounded-lg prose-pre:p-4 prose-pre:text-foreground prose-pre:overflow-x-auto
